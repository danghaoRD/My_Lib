 ...
 *
 *  22/05/2020    Đ.V.Hào (k57 UTC) first edited line 80, 84.  __IO --> volatile (or without __IO)
...
/// Erase page add by Đ.V.Hào 23/May/2020
...
void Flash_Read_Data (uint32_t StartPageAddress,   uint32_t * DATA_32)
{
	while (1)
	{
		*DATA_32 = *(  uint32_t *)StartPageAddress;
